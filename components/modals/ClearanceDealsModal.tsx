                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="relative w-24 h-12 bg-white rounded-lg p-2 shadow-sm">
                        <Image
                          src={deal.logo}
                          alt={`${deal.brand} logo`}
                          fill
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-amber-100 to-orange-100 rounded-xl border-2 border-amber-200">
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  ...
                  <Button 
                    className="bg-gradient-to-r from-gray-800 to-black hover:from-gray-900 hover:to-gray-800 text-white font-bold px-6 py-3 rounded-xl text-sm active:scale-95 transition-transform"
