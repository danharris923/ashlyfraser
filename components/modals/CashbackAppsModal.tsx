...
export default function CashbackAppsModal({ isOpen, onClose }: CashbackAppsModalProps) {
  ...
  return (
    ...
    >
      <div 
        className="fixed bottom-0 left-0 right-0 top-16 md:top-8 md:bottom-8 md:left-8 md:right-8 md:max-w-4xl md:mx-auto flex flex-col bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 animate-in slide-in-from-bottom duration-300 rounded-t-2xl md:rounded-2xl shadow-2xl"
