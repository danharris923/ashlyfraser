...
interface FreeSamplesModalProps {
  isOpen: boolean
  onClose: () => void
}
        ...
        <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-md border-b border-emerald-200">
          <div className="flex items-center h-14 px-4">
            ...
            <div className="flex-1">
              <h1 className="text-lg font-semibold text-emerald-800">Free Samples Canada</h1>
              <p className="text-xs text-emerald-600">Best Sources for Free Products</p>
            </div>
          </div>
        </div>
