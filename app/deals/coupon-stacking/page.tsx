...
export default function CouponStackingPage() {
      ...
      <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-md border-b border-indigo-200">
        <div className="flex items-center h-16 px-4 max-w-7xl mx-auto">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-bold text-indigo-800">Coupon Stacking Mastery</h1>
            <p className="text-sm text-indigo-600">Free Savings Guide</p>
          </div>
        </div>
      </div>
